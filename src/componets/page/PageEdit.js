...
export default class PageEdit extends Component {
  render() {
    ...
    <span className="navbar-brand mb-0 h1 text-info">Edit Page</span>
...
<div className="container">
    <form>
        <div className="form-group">
            ...
            <input placeholder="Blog Post" className="form-control" type="text" id="page-name" name="page-name"/>
        </div>
        <div className="form-group">
    ...
    <a className="btn btn-danger btn-block" href="page-list.html">Delete</a>
</div>            
