...
<form>
    <div className="form-group">
        ...
        <input placeholder="Enter a name for this widget..." type="text" id="name" name="name"
            className="form-control"/>
    </div>
    <div className="form-group">
        <label className="text-info" for="text">Text</label>
        <input placeholder="Enter a text description for this image (optional)" type="text" id="text"
    ...
    <div className="form-group">
        ...
        <option value="0" label="0%" value="10" value="20" value="30" value="40" value="50" label="50%"
            value="60" value="70" value="80" value="90" value="100" label="100%"></option>
        </detalist>
    </div>
